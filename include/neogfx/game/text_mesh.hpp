...
namespace neogfx::game
{
    ...
    namespace shape
    {
        ...
        public:
            text(i_ecs& aEcs, i_graphics_context const& aGc, std::string const& aText, const neogfx::font& aFont, const neogfx::text_appearance& aAppearance, neogfx::alignment aAlignment = alignment::Left);
