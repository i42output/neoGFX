...
namespace neogfx
{
	...
	{
	public:
		frame(const effect_colour& aColour) : iColour(aColour) {}
		frame(const effect_colour& aColour, const mat33& aTransformation) : iColour(aColour), iTransformation(aTransformation) {}
	...
	public:
		...
		const optional_effect_colour& colour() const override { return iColour; }
		void set_colour(const optional_effect_colour& aColour) override { iColour = aColour; }
	...
	private:
		optional_effect_colour iColour;
