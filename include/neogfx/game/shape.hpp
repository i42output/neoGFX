...
namespace neogfx
{
	...
	public:
		...
		size extents() const override { return has_extents() ? (*iTextures)[0].second != std::nullopt ? *(*iTextures)[0].second : (*iTextures)[0].first->extents() : size{}; }
	...
	public:
		...
		typedef std::optional<animation_info> optional_animation_info;
	public:
		shape();
