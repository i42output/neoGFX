...
namespace neogfx
{
	...
	public:
		...
		void add_item_at(item_index aPosition, i_widget& aWidget) override;
		void add_item(std::shared_ptr<i_widget> aWidget) override;
		void add_item_at(item_index aPosition, std::shared_ptr<i_widget> aWidget) override;
		void add_item(i_layout& aLayout) override;
		void add_item_at(item_index aPosition, i_layout& aLayout) override;
		void add_item(std::shared_ptr<i_layout> aLayout) override;
		void add_item_at(item_index aPosition, std::shared_ptr<i_layout> aLayout) override;
		void add_item(i_spacer& aSpacer) override;
		void add_item_at(item_index aPosition, i_spacer& aSpacer) override;
		void add_item(std::shared_ptr<i_spacer> aSpacer) override;
		void add_item_at(item_index aPosition, std::shared_ptr<i_spacer> aSpacer) override;
		void add_item(const item& aItem) override;
		...
		optional_item_index find_item(i_layout& aItem) const override;
		optional_item_index find_item(i_widget& aItem) const override;
		optional_item_index find_item(const layout_item& aItem) const override;
