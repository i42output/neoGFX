...
namespace neogfx
{
	...
	public:
		...
		virtual widget_list::const_iterator last_child() const;
		virtual widget_list::iterator last_child();
		virtual widget_list::const_iterator find_child(const i_widget& aChild, bool aThrowIfNotFound = true) const;
		virtual widget_list::iterator find_child(const i_widget& aChild, bool aThrowIfNotFound = true);
		virtual const i_widget& before() const;
		virtual i_widget& before();
		virtual const i_widget& after() const;
		virtual i_widget& after();
		virtual void link_before(i_widget* aPreviousWidget);
		virtual void link_after(i_widget* aNextWidget);
		virtual void unlink();
