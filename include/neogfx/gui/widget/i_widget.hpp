...
namespace neogfx
{
    ...
    public:
        ...
        virtual void mouse_button_clicked(mouse_button aButton, const point& aPosition, key_modifier aKeyModifier) = 0;
        virtual void mouse_button_double_clicked(mouse_button aButton, const point& aPosition, key_modifier aKeyModifier) = 0;
        virtual void mouse_button_click(mouse_button aButton, const point& aPosition, key_modifier aKeyModifier) = 0;
        virtual void mouse_button_double_click(mouse_button aButton, const point& aPosition, key_modifier aKeyModifier) = 0;
        virtual void mouse_button_released(mouse_button aButton, const point& aPosition) = 0;
        virtual void mouse_moved(const point& aPosition, key_modifier aKeyModifier) = 0;
