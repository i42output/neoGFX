...
namespace neogfx
{
    ...
    public:
        ...
        i_graphics_context& dilate_octagon(rect const& aDestinationRect, i_graphics_context& aSource, rect const& aSourceRect, std::uint32_t aTaps, vec2 const& aDirection, neogfx::blending_mode aBlendingMode = neogfx::blending_mode::None) final;
        i_graphics_context& dilate_disk(rect const& aDestinationRect, i_graphics_context& aSource, rect const& aSourceRect, scalar aRadius, neogfx::blending_mode aBlendingMode = neogfx::blending_mode::None) final;
        // gradient
    public:
