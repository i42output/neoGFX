...
namespace neogfx
{
    ...
    public:
        ...
        void draw_text(const point& aPoint, std::string const& aText, const font& aFont, const text_attributes& aTextAttributes) const final;
        void draw_text(const point& aPoint, std::string::const_iterator aTextBegin, std::string::const_iterator aTextEnd, const font& aFont, const text_attributes& aTextAttributes) const final;
        void draw_text(const vec3& aPoint, std::string const& aText, const font& aFont, const text_attributes& aTextAttributes) const final;
        void draw_text(const vec3& aPoint, std::string::const_iterator aTextBegin, std::string::const_iterator aTextEnd, const font& aFont, const text_attributes& aTextAttributes) const final;
        void draw_multiline_text(const point& aPoint, std::string const& aText, const font& aFont, const text_attributes& aTextAttributes, alignment aAlignment = alignment::Left) const final;
        void draw_multiline_text(const point& aPoint, std::string const& aText, const font& aFont, dimension aMaxWidth, const text_attributes& aTextAttributes, alignment aAlignment = alignment::Left) const final;
        void draw_multiline_text(const vec3& aPoint, std::string const& aText, const font& aFont, const text_attributes& aTextAttributes, alignment aAlignment = alignment::Left) const final;
        void draw_multiline_text(const vec3& aPoint, std::string const& aText, const font& aFont, dimension aMaxWidth, const text_attributes& aTextAttributes, alignment aAlignment = alignment::Left) const final;
        void draw_glyph_text(const point& aPoint, const glyph_text& aText, const text_attributes& aTextAttributes) const final;
        void draw_glyph_text(const point& aPoint, const glyph_text& aText, glyph_text::const_iterator aTextBegin, glyph_text::const_iterator aTextEnd, const text_attributes& aTextAttributes) const final;
        void draw_glyph_text(const vec3& aPoint, const glyph_text& aText, const text_attributes& aTextAttributes) const final;
        void draw_glyph_text(const vec3& aPoint, const glyph_text& aText, glyph_text::const_iterator aTextBegin, glyph_text::const_iterator aTextEnd, const text_attributes& aTextAttributes) const final;
        void draw_multiline_glyph_text(const point& aPoint, const glyph_text& aText, dimension aMaxWidth, const text_attributes& aTextAttributes, alignment aAlignment = alignment::Left) const final;
        void draw_multiline_glyph_text(const vec3& aPoint, const glyph_text& aText, dimension aMaxWidth, const text_attributes& aTextAttributes, alignment aAlignment = alignment::Left) const final;
        void draw_glyph(const point& aPoint, const glyph_text& aText, const glyph& aGlyph, const text_attributes& aTextAttributes) const final;
        void draw_glyph(const vec3& aPoint, const glyph_text& aText, const glyph& aGlyph, const text_attributes& aTextAttributes) const final;
        void draw_glyphs(const point& aPoint, const glyph_text& aText, const text_attribute_spans& aAttributes) const final;
        void draw_glyphs(const vec3& aPoint, const glyph_text& aText, const text_attribute_spans& aAttributes) const final;
