...
namespace neogfx
{
    ...
    public:
        ...
        i_action& set_enabled(bool aEnabled) override;
        i_action& set_checkable(bool aCheckable = true) override;
        i_action& set_checked(bool aChecked) override;
        i_action& set_group(uuid const& aGroup) override;
        i_action& set_separator(bool aIsSeparator) override;
        i_action& set_text(i_optional<i_string> const& aText = optional_text()) override;
        i_action& set_menu_text(i_optional<i_string> const& aMenuText = optional_text()) override;
        i_action& set_button_text(i_optional<i_string> const& aButtonText = optional_text()) override;
        i_action& set_tool_tip_text(i_optional<i_string> const& aToolTipText = optional_text()) override;
        i_action& set_help_text(i_optional<i_string> const& aHelpText = optional_text()) override;
        i_action& set_image(const i_texture& aTexture) override;
        i_action& set_checked_image(const i_texture& aTexture) override;
        i_action& set_shortcut(const optional_key_sequence& aShortcut) override;
        i_action& set_shortcut(i_string const& aShortcut) override;
    public:
