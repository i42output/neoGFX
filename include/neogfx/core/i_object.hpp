...
namespace neogfx
{
    enum class object_type : uint64_t
    {
        ...
        MASK_USER           = 0x00FFFFFFFFFF0000,

        MASK_TYPE           = 0x00000000FFFFFFFF,
        MASK_SUBCATEGORY    = 0x00000FFF00000000,
        ...
        Widget              = 0x0000200000000000 | HasGeometry | LayoutItem,
        Layout              = 0x0000400000000000 | HasGeometry | LayoutItem,
        Menu                = 0x0000800000000000 | HasActions,
        Button              = 0x0001000000000000 | Widget | HasText | HasLabel | HasImage,

        App                 = 0x0000000000000001 | HasActions,
        Window              = 0x0000000000000002 | Widget,
