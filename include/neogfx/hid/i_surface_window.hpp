...
namespace neogfx
{
    ...
    public:
        ...
        virtual void native_window_mouse_button_double_clicked(mouse_button aButton, const point& aPosition, key_modifier aKeyModifier) = 0;
        virtual void native_window_mouse_button_click(mouse_button aButton, const point& aPosition, key_modifier aKeyModifier) = 0;
        virtual void native_window_mouse_button_double_click(mouse_button aButton, const point& aPosition, key_modifier aKeyModifier) = 0;
        virtual void native_window_mouse_button_released(mouse_button aButton, const point& aPosition) = 0;
        virtual void native_window_mouse_moved(const point& aPosition, key_modifier aKeyModifier) = 0;
        virtual void native_window_non_client_mouse_wheel_scrolled(mouse_wheel aWheel, const point& aPosition, delta aDelta, key_modifier aKeyModifier) = 0;
        virtual void native_window_non_client_mouse_button_clicked(mouse_button aButton, const point& aPosition, key_modifier aKeyModifier) = 0;
        virtual void native_window_non_client_mouse_button_double_clicked(mouse_button aButton, const point& aPosition, key_modifier aKeyModifier) = 0;
        virtual void native_window_non_client_mouse_button_click(mouse_button aButton, const point& aPosition, key_modifier aKeyModifier) = 0;
        virtual void native_window_non_client_mouse_button_double_click(mouse_button aButton, const point& aPosition, key_modifier aKeyModifier) = 0;
        virtual void native_window_non_client_mouse_button_released(mouse_button aButton, const point& aPosition) = 0;
        virtual void native_window_non_client_mouse_moved(const point& aPosition, key_modifier aKeyModifier) = 0;
        ...
        virtual void native_window_key_pressed(scan_code_e aScanCode, key_code_e aKeyCode, key_modifier aKeyModifier) = 0;
        virtual void native_window_key_released(scan_code_e aScanCode, key_code_e aKeyCode, key_modifier aKeyModifier) = 0;
