...
namespace neogfx::nrc
{
    ...
    protected:
        ...
        void emit_preamble() const override
        {
            switch (type())
            {
            case ui_element_type::Slider:
                emit("  spin_box %1%;\n", id());
                break;
            case ui_element_type::DoubleSlider:
    ...
    typedef basic_spin_box<int32_t, ui_element_type::Slider> spin_box;
    typedef basic_spin_box<double, ui_element_type::DoubleSlider> double_spin_box;
}
