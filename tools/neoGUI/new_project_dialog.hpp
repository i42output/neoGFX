...
namespace neogui
{
	...
	public:
		new_project_dialog(i_widget& aParent) :
			...
			iNewMVCApp{ iGroupBox1.item_layout(), "MVC (Model-View-Controller) App" },
			iNewDialogApp{ iGroupBox1.item_layout(), "Dialog App" },
			iNew2DGame{ iGroupBox1.item_layout(), "2D Game" },
			iNew25DGame{ iGroupBox1.item_layout(), "2.5D (Isometric) Game" },
			iNew3DGame{ iGroupBox1.item_layout(), "3D Game" },
