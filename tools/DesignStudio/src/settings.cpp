...
namespace neogfx::DesignStudio
{
        ...
        base_type{}
    {
        ...
        register_setting<extended_font>("environment.fonts_and_colors.editor_font"_s, extended_font{ service<i_app>().current_style().font_info(), text_attributes{} }, "Editor font: %?%"_t);
        register_setting<extended_font>("environment.fonts_and_colors.console_font"_s, extended_font{ service<i_app>().current_style().font_info(), text_attributes{} }, "Console font: %?%"_t);
