...
namespace neogfx::DesignStudio
{
        ...
        base_type{}
    {
        ...
        register_setting<double>("environment.tabs_and_windows.left_dock_width"_s, 192.0_dip);
        register_setting<double>("environment.tabs_and_windows.right_dock_width"_s, 256.0_dip);
