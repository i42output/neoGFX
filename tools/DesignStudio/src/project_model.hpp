...
{
    typedef ng::basic_item_tree_model<std::variant<ds::element_group, element_tool_t>> project_model;

    extern template class element_presentation_model<project_model>;

    class project_presentation_model : public element_presentation_model<project_model>
    {
        typedef element_presentation_model base_type;
    public:
        project_presentation_model(i_project_manager& aProjectManager);
    public:
