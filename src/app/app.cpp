...
namespace neogfx
{
    ...
    app::app(int argc, char* argv[], const std::string& aName)
        ...
        actionFileNew{ "&New..."_t, ":/neogfx/resources/icons.zip#new.png" },
        actionFileOpen{ "&Open..."_t, ":/neogfx/resources/icons.zip#open.png" },
        actionFileClose{ "&Close"_t },
        actionFileCloseAll{ "Close All"_t },
        actionFileSave{ "&Save"_t, ":/neogfx/resources/icons.zip#save.png" },
        actionFileSaveAll{ "Save A&ll"_t },
        actionFileExit{ "E&xit"_t },
        actionUndo{ "Undo"_t, ":/neogfx/resources/icons.zip#undo.png" },
        actionRedo{ "Redo"_t, ":/neogfx/resources/icons.zip#redo.png" },
        actionCut{ "Cut"_t, ":/neogfx/resources/icons.zip#cut.png" },
        actionCopy{ "Copy"_t, ":/neogfx/resources/icons.zip#copy.png" },
        actionPaste{ "Paste"_t, ":/neogfx/resources/icons.zip#paste.png" },
