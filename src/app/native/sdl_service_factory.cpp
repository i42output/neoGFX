...
namespace neogfx
{
	...
	public:
		...
		virtual std::unique_ptr<i_rendering_engine> create_rendering_engine(i_basic_services& aBasicServices, i_keyboard& aKeyboard)
		{
			return std::make_unique<sdl_renderer>(aBasicServices, aKeyboard);
		}
	};
