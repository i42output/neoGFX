...
namespace neogfx
{
	...
	const i_geometry& layout_item::wrapped_geometry() const
	{
	...
	i_geometry& layout_item::wrapped_geometry()
	{
		return const_cast<i_geometry&>(const_cast<const layout_item*>(this)->wrapped_geometry());
	}
