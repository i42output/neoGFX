    ...
    namespace native::windows
    {
        ...
        const xinput_controller::button_map_type& xinput_controller::xinput_button_map()
        {
            static auto const sXinputButtonMap = make_bimap<game_controller_button_ordinal, game_controller_button>(
                {
                    { 0u, game_controller_button::A },
                    { 1u, game_controller_button::B },
                    { 2u, game_controller_button::X },
                    { 3u, game_controller_button::Y },
                    { 4u, game_controller_button::LeftShoulder },
                    { 5u, game_controller_button::RightShoulder },
                    { 6u, game_controller_button::Back },
                    { 7u, game_controller_button::Start },
                    { 8u, game_controller_button::LeftThumb },
                    { 9u, game_controller_button::RightThumb },
                    // todo: what should the mapping of the rest of these actually be? see what DirectInput says.
                    { 10u, game_controller_button::LeftTrigger },
                    { 11u, game_controller_button::RightTrigger },
                    { 12u, game_controller_button::DirectionalPadUp },
                    { 13u, game_controller_button::DirectionalPadDown },
                    { 14u, game_controller_button::DirectionalPadLeft },
                    { 15u, game_controller_button::DirectionalPadRight },
                    { 16u, game_controller_button::LeftThumbUp },
                    { 17u, game_controller_button::LeftThumbDown },
                    { 18u, game_controller_button::LeftThumbRight },
                    { 19u, game_controller_button::LeftThumbLeft },
                    { 20u, game_controller_button::LeftThumbUpLeft },
                    { 21u, game_controller_button::LeftThumbUpRight },
                    { 22u, game_controller_button::LeftThumbDownRight },
                    { 23u, game_controller_button::LeftThumbDownLeft },
                    { 24u, game_controller_button::RightThumbUp },
                    { 25u, game_controller_button::RightThumbDown },
                    { 26u, game_controller_button::RightThumbRight },
                    { 27u, game_controller_button::RightThumbLeft },
                    { 28u, game_controller_button::RightThumbUpLeft },
                    { 29u, game_controller_button::RightThumbUpRight },
                    { 30u, game_controller_button::RightThumbDownRight },
                    { 31u, game_controller_button::RightThumbDownLeft }
                });
