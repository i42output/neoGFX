...
namespace neogfx
{
	...
	public:
		...
		virtual void draw_circle(const point& aCentre, dimension aRadius, const pen& aPen, angle aStartAngle) = 0;
		...
		virtual void draw_shape(const vec2_list& aVertices, const pen& aPen) = 0;
		...
		virtual void fill_shape(const vec2_list& aVertices, const fill& aFill) = 0;
