...
namespace neogfx
{
    namespace graphics_operation
    {
        std::string to_string(operation_type aOpType)
        {
            ...
            case SetOrigin: return "SetOrigin";
            case SetViewport: return "SetViewport";
            case SetViewTransformation: return "SetViewTransformation";
            ...
            case SetFrontFace: return "SetFrontFace";
            case SetCullFaces: return "SetCullFaces";
            ...
            case EnableStencilTest: return "EnableStencilTest";
            case DisableStencilTest: return "DisableStencilTest";
            case EnableStencilUpdate: return "EnableStencilUpdate";
