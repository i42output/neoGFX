...
#include <neogfx/gfx/text/skyline_bin_pack.hpp>

namespace neogfx
{
	class native_font_texture : public i_font_texture
	{
	public:
		native_font_texture(const size& aExtents, bool aSubPixelRendering);
		~native_font_texture();
	public:
