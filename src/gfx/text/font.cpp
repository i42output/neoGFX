...
namespace neogfx
{
    ...
    std::string const& font_info::family_name() const
    {
    ...
    std::string const& font_info::style_name() const
    {
    ...
    std::string const& font::family_name() const
    {
    ...
    std::string const& font::style_name() const
    {
